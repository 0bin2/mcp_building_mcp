...
MCP_DOCS_PATH = os.getenv("MCP_DOCS_PATH")
MCP_DOCS_CONTENT = open(MCP_DOCS_PATH, "r").read()

# Python SDK README content
PYTHON_SDK_PATH = os.getenv("PYTHON_SDK_PATH")
PYTHON_SDK_CONTENT = open(PYTHON_SDK_PATH, "r").read()
